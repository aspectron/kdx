...
//		let id = task.id;
		...
		return html`
			...
			<flow-data-field has-colon x-prefix="5M AVG" suffix="${rate_hr_unit} / HOUR" title="STORAGE RATE | 5M AVG" @click=${this.updateStorageSize}>${rate_hr}</flow-data-field>
			<flow-data-field has-colon x-prefix="5M AVG" suffix="${rate_year_unit} / YEAR" title="STORAGE RATE | 5M AVG" @click=${this.updateStorageSize}>${rate_year}</flow-data-field>
