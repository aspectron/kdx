...
//				const sync = (blockCount/headerCount)*100;
				...
				const pastMedianTimeDiff = Date.now() - pastMedianTime;
...
//console.log("KDX INSTANCE:",this);
				...
				if(this.task.id == 'kd0') {
					...
					this.manager.emit(`sync-status`, { sync: syncSample, headerCount, blockCount, id : this.task.id, pastMedianTime, pastMedianTimeDiff });
				}
